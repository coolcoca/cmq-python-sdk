...
class Message:
    ...
    def __str__(self):
        msg_info = {
            ...
            "msgId": self.msgId,
            "enqueueTime": time.strftime(
                "%Y/%m/%d %H:%M:%S", time.localtime(self.enqueueTime)),
            "nextVisibleTime": time.strftime(
                "%Y/%m/%d %H:%M:%S", time.localtime(self.nextVisibleTime)),
            "firstDequeueTime": time.strftime(
                "%Y/%m/%d %H:%M:%S", time.localtime(self.firstDequeueTime)),
